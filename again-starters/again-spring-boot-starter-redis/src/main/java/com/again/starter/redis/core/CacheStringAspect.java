package com.again.starter.redis.core;

import com.again.starter.redis.config.CachePropertiesHolder;
import com.again.starter.redis.core.annotation.CacheDel;
import com.again.starter.redis.core.annotation.CachePut;
import com.again.starter.redis.core.annotation.Cached;
import com.again.starter.redis.operation.CacheDelOps;
import com.again.starter.redis.operation.CachePutOps;
import com.again.starter.redis.operation.CachedOps;
import com.again.starter.redis.operation.function.VoidMethod;
import com.again.starter.redis.serialize.CacheSerializer;
...
public class CacheStringAspect {
	...
	@Pointcut("execution(@(@com.again.starter.redis.core.annotation.MetaCacheAnnotation *) * *(..))")
