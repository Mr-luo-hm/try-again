...
public final class CommonServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.again.extend.grpc.Request,
      com.again.extend.grpc.Response> getMethodMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "method",
      requestType = com.again.extend.grpc.Request.class,
      responseType = com.again.extend.grpc.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.again.extend.grpc.Request,
      com.again.extend.grpc.Response> getMethodMethod() {
    ...
    if ((getMethodMethod = CommonServiceGrpc.getMethodMethod) == null) {
      synchronized (CommonServiceGrpc.class) {
        if ((getMethodMethod = CommonServiceGrpc.getMethodMethod) == null) {
          CommonServiceGrpc.getMethodMethod = getMethodMethod = 
              io.grpc.MethodDescriptor.<com.again.extend.grpc.Request, com.again.extend.grpc.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "CommonService", "method"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.again.extend.grpc.Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.again.extend.grpc.Response.getDefaultInstance()))
                  .setSchemaDescriptor(new CommonServiceMethodDescriptorSupplier("method"))
                  .build();
          }
        }
     }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.again.extend.grpc.Request,
                com.again.extend.grpc.Response>(
